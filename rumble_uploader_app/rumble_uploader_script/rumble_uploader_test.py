...
rumble_green_upload_button = 'button.header-upload'    #body > header > div > div > button.header-upload
...
def upload_to_rumble(rumble_video_script_serialized_data):
    ...
    time.sleep(random_wait_time)  # Wait for 10 seconds
